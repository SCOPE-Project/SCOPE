...
class AssetRepository:
    ...
    def initialize_repository(cls) -> list[dict]:
        ...
        if cls._satellite_cache or cls._groundstation_cache or cls._ineligible_cache:
            return RuntimeError("Caches were not cleared properly before initialization.")
