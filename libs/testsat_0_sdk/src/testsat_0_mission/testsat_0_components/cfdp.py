...
class Cfdp(Component):
    ...
    def __init__(self):
        """Component creation of testsat_0.cfdp."""
        super().__init__(description='CFDP Service component for sending and receiving files', id_path='testsat_0.cfdp')
    ...
    class Cmd_put(SdkCommand):
        ...
        relative_execution_info: RelativeInfoModel | None = None):
            ...
            # int limit check for {'min': 0, 'max': 9007199254740991, 'defaultValue': 3}
    ...
    def Var_dl_transaction_id(self) -> SdkVariable:
        ...
        return SdkVariable(ParameterDefModel.model_validate({'enumDefinition': None, 'floatDefinition': None, 'matrixDefinition': None, 'octetDefinition': None, 'sintDefinition': {'min': 0, 'max': 9007199254740991, 'defaultValue': 0}, 'stringDefinition': None, 'timeDefinition': None, 'name': 'dl_transaction_id', 'description': 'Transaction ID for DOWNLINK link', 'unit': ''}), id_path="testsat_0.cfdp.dl_transaction_id"
        )
    
    @property
    def Var_dl_condition_code(self) -> SdkVariable:
        """Condition code of the corresponding transaction id the DOWNLINK link."""
        return SdkVariable(ParameterDefModel.model_validate({'enumDefinition': {'values': {0: 'NO_ERROR', -1: 'NO_CONDITION_FIELD', 1: 'POSITIVE_ACK_LIMIT_REACHED', 2: 'KEEP_ALIVE_LIMIT_REACHED', 3: 'INVALID_TRANSMISSION_MODE', 4: 'FILESTORE_REJECTION', 5: 'FILE_CHECKSUM_FAILURE', 6: 'FILE_SIZE_ERROR', 7: 'NAK_LIMIT_REACHED', 8: 'INACTIVITY_DETECTED', 10: 'CHECK_LIMIT_REACHED', 11: 'UNSUPPORTED_CHECKSUM_TYPE', 14: 'SUSPEND_REQUEST_RECEIVED', 15: 'CANCEL_REQUEST_RECEIVED'}, 'defaultValue': None}, 'floatDefinition': None, 'matrixDefinition': None, 'octetDefinition': None, 'sintDefinition': None, 'stringDefinition': None, 'timeDefinition': None, 'name': 'dl_condition_code', 'description': 'Condition code of the corresponding transaction id the DOWNLINK link', 'unit': ''}), id_path="testsat_0.cfdp.dl_condition_code"
        )
    
    @property
    def Var_dl_delivery_code(self) -> SdkVariable:
        """Delivery code of the corresponding transaction id the DOWNLINK link."""
        return SdkVariable(ParameterDefModel.model_validate({'enumDefinition': {'values': {0: 'DATA_COMPLETE', 1: 'DATA_INCOMPLETE'}, 'defaultValue': None}, 'floatDefinition': None, 'matrixDefinition': None, 'octetDefinition': None, 'sintDefinition': None, 'stringDefinition': None, 'timeDefinition': None, 'name': 'dl_delivery_code', 'description': 'Delivery code of the corresponding transaction id the DOWNLINK link', 'unit': ''}), id_path="testsat_0.cfdp.dl_delivery_code"
        )
    
    @property
    def Var_dl_file_status(self) -> SdkVariable:
        """File status of the corresponding transaction id the DOWNLINK link."""
        return SdkVariable(ParameterDefModel.model_validate({'enumDefinition': {'values': {0: 'DISCARDED_DELIBERATELY', 1: 'DISCARDED_FILESTORE_REJECTION', 2: 'FILE_RETAINED', 3: 'FILE_STATUS_UNREPORTED'}, 'defaultValue': None}, 'floatDefinition': None, 'matrixDefinition': None, 'octetDefinition': None, 'sintDefinition': None, 'stringDefinition': None, 'timeDefinition': None, 'name': 'dl_file_status', 'description': 'File status of the corresponding transaction id the DOWNLINK link', 'unit': ''}), id_path="testsat_0.cfdp.dl_file_status"
        )
    
    @property
    def Var_dl_file_size(self) -> SdkVariable:
        """Size of the file for the corresponding transaction id the DOWNLINK link."""
        return SdkVariable(ParameterDefModel.model_validate({'enumDefinition': None, 'floatDefinition': None, 'matrixDefinition': None, 'octetDefinition': None, 'sintDefinition': {'min': 0, 'max': 9007199254740991, 'defaultValue': 0}, 'stringDefinition': None, 'timeDefinition': None, 'name': 'dl_file_size', 'description': 'Size of the file for the corresponding transaction id the DOWNLINK link', 'unit': ''}), id_path="testsat_0.cfdp.dl_file_size"
        )
    
    @property
    def Var_dl_src_file_name(self) -> SdkVariable:
        """Name of the source file for the corresponding transaction id the DOWNLINK link."""
        return SdkVariable(ParameterDefModel.model_validate({'enumDefinition': None, 'floatDefinition': None, 'matrixDefinition': None, 'octetDefinition': None, 'sintDefinition': None, 'stringDefinition': {'defaultValue': ''}, 'timeDefinition': None, 'name': 'dl_src_file_name', 'description': 'Name of the source file for the corresponding transaction id the DOWNLINK link', 'unit': ''}), id_path="testsat_0.cfdp.dl_src_file_name"
        )
    ...
    def Var_dl_dst_file_name(self) -> SdkVariable:
        ...
        return SdkVariable(ParameterDefModel.model_validate({'enumDefinition': None, 'floatDefinition': None, 'matrixDefinition': None, 'octetDefinition': None, 'sintDefinition': None, 'stringDefinition': {'defaultValue': ''}, 'timeDefinition': None, 'name': 'dl_dst_file_name', 'description': 'Name of the destination file for the corresponding transaction id the DOWNLINK link', 'unit': ''}), id_path="testsat_0.cfdp.dl_dst_file_name"
        )
    ...
    def Var_dl_message_to_user(self) -> SdkVariable:
        ...
        return SdkVariable(ParameterDefModel.model_validate({'enumDefinition': None, 'floatDefinition': None, 'matrixDefinition': None, 'octetDefinition': None, 'sintDefinition': None, 'stringDefinition': {'defaultValue': ''}, 'timeDefinition': None, 'name': 'dl_message_to_user', 'description': 'Message to user for the corresponding transaction id the DOWNLINK link, if the S/C delivers them.', 'unit': ''}), id_path="testsat_0.cfdp.dl_message_to_user"
        )
    
    @property
    def Var_dl_file_progress(self) -> SdkVariable:
        """File progress of the corresponding transaction id the DOWNLINK link."""
        return SdkVariable(ParameterDefModel.model_validate({'enumDefinition': None, 'floatDefinition': {'min': 0.0, 'max': 100.0, 'defaultValue': 0.0}, 'matrixDefinition': None, 'octetDefinition': None, 'sintDefinition': None, 'stringDefinition': None, 'timeDefinition': None, 'name': 'dl_file_progress', 'description': 'File progress of the corresponding transaction id the DOWNLINK link', 'unit': '%'}), id_path="testsat_0.cfdp.dl_file_progress"
        )
    
    @property
    def Var_up_transaction_id(self) -> SdkVariable:
        """Transaction ID for UPLINK link."""
        return SdkVariable(ParameterDefModel.model_validate({'enumDefinition': None, 'floatDefinition': None, 'matrixDefinition': None, 'octetDefinition': None, 'sintDefinition': {'min': 0, 'max': 9007199254740991, 'defaultValue': 0}, 'stringDefinition': None, 'timeDefinition': None, 'name': 'up_transaction_id', 'description': 'Transaction ID for UPLINK link', 'unit': ''}), id_path="testsat_0.cfdp.up_transaction_id"
        )
    
    @property
    def Var_up_condition_code(self) -> SdkVariable:
        """Condition code of the corresponding transaction id the UPLINK link."""
        return SdkVariable(ParameterDefModel.model_validate({'enumDefinition': {'values': {0: 'NO_ERROR', -1: 'NO_CONDITION_FIELD', 1: 'POSITIVE_ACK_LIMIT_REACHED', 2: 'KEEP_ALIVE_LIMIT_REACHED', 3: 'INVALID_TRANSMISSION_MODE', 4: 'FILESTORE_REJECTION', 5: 'FILE_CHECKSUM_FAILURE', 6: 'FILE_SIZE_ERROR', 7: 'NAK_LIMIT_REACHED', 8: 'INACTIVITY_DETECTED', 10: 'CHECK_LIMIT_REACHED', 11: 'UNSUPPORTED_CHECKSUM_TYPE', 14: 'SUSPEND_REQUEST_RECEIVED', 15: 'CANCEL_REQUEST_RECEIVED'}, 'defaultValue': None}, 'floatDefinition': None, 'matrixDefinition': None, 'octetDefinition': None, 'sintDefinition': None, 'stringDefinition': None, 'timeDefinition': None, 'name': 'up_condition_code', 'description': 'Condition code of the corresponding transaction id the UPLINK link', 'unit': ''}), id_path="testsat_0.cfdp.up_condition_code"
        )
    
    @property
    def Var_up_delivery_code(self) -> SdkVariable:
        """Delivery code of the corresponding transaction id the UPLINK link."""
        return SdkVariable(ParameterDefModel.model_validate({'enumDefinition': {'values': {0: 'DATA_COMPLETE', 1: 'DATA_INCOMPLETE'}, 'defaultValue': None}, 'floatDefinition': None, 'matrixDefinition': None, 'octetDefinition': None, 'sintDefinition': None, 'stringDefinition': None, 'timeDefinition': None, 'name': 'up_delivery_code', 'description': 'Delivery code of the corresponding transaction id the UPLINK link', 'unit': ''}), id_path="testsat_0.cfdp.up_delivery_code"
        )
    
    @property
    def Var_up_file_status(self) -> SdkVariable:
        """File status of the corresponding transaction id the UPLINK link."""
        return SdkVariable(ParameterDefModel.model_validate({'enumDefinition': {'values': {0: 'DISCARDED_DELIBERATELY', 1: 'DISCARDED_FILESTORE_REJECTION', 2: 'FILE_RETAINED', 3: 'FILE_STATUS_UNREPORTED'}, 'defaultValue': None}, 'floatDefinition': None, 'matrixDefinition': None, 'octetDefinition': None, 'sintDefinition': None, 'stringDefinition': None, 'timeDefinition': None, 'name': 'up_file_status', 'description': 'File status of the corresponding transaction id the UPLINK link', 'unit': ''}), id_path="testsat_0.cfdp.up_file_status"
        )
    
    @property
    def Var_up_file_size(self) -> SdkVariable:
        """Size of the file for the corresponding transaction id the UPLINK link."""
        return SdkVariable(ParameterDefModel.model_validate({'enumDefinition': None, 'floatDefinition': None, 'matrixDefinition': None, 'octetDefinition': None, 'sintDefinition': {'min': 0, 'max': 9007199254740991, 'defaultValue': 0}, 'stringDefinition': None, 'timeDefinition': None, 'name': 'up_file_size', 'description': 'Size of the file for the corresponding transaction id the UPLINK link', 'unit': ''}), id_path="testsat_0.cfdp.up_file_size"
        )
    
    @property
    def Var_up_src_file_name(self) -> SdkVariable:
        """Name of the source file for the corresponding transaction id the UPLINK link."""
        return SdkVariable(ParameterDefModel.model_validate({'enumDefinition': None, 'floatDefinition': None, 'matrixDefinition': None, 'octetDefinition': None, 'sintDefinition': None, 'stringDefinition': {'defaultValue': ''}, 'timeDefinition': None, 'name': 'up_src_file_name', 'description': 'Name of the source file for the corresponding transaction id the UPLINK link', 'unit': ''}), id_path="testsat_0.cfdp.up_src_file_name"
        )
    ...
    def Var_up_dst_file_name(self) -> SdkVariable:
        ...
        return SdkVariable(ParameterDefModel.model_validate({'enumDefinition': None, 'floatDefinition': None, 'matrixDefinition': None, 'octetDefinition': None, 'sintDefinition': None, 'stringDefinition': {'defaultValue': ''}, 'timeDefinition': None, 'name': 'up_dst_file_name', 'description': 'Name of the destination file for the corresponding transaction id the UPLINK link', 'unit': ''}), id_path="testsat_0.cfdp.up_dst_file_name"
        )
    ...
    def Var_up_message_to_user(self) -> SdkVariable:
        ...
        return SdkVariable(ParameterDefModel.model_validate({'enumDefinition': None, 'floatDefinition': None, 'matrixDefinition': None, 'octetDefinition': None, 'sintDefinition': None, 'stringDefinition': {'defaultValue': ''}, 'timeDefinition': None, 'name': 'up_message_to_user', 'description': 'Message to user for the corresponding transaction id the UPLINK link, if the S/C delivers them.', 'unit': ''}), id_path="testsat_0.cfdp.up_message_to_user"
        )
    
    @property
    def Var_up_file_progress(self) -> SdkVariable:
        """File progress of the corresponding transaction id the UPLINK link."""
        return SdkVariable(ParameterDefModel.model_validate({'enumDefinition': None, 'floatDefinition': {'min': 0.0, 'max': 100.0, 'defaultValue': 0.0}, 'matrixDefinition': None, 'octetDefinition': None, 'sintDefinition': None, 'stringDefinition': None, 'timeDefinition': None, 'name': 'up_file_progress', 'description': 'File progress of the corresponding transaction id the UPLINK link', 'unit': '%'}), id_path="testsat_0.cfdp.up_file_progress"
        )
