...
class Sat1_Group1(Satellite):
    ...
    def __init__(self):
        ...
        satellite_model = SatelliteModel.model_validate({'version': {'major': 0, 'minor': 2, 'patch': 0, 'description': None}, 'archived': False, 'name': 'Sat1_Group1', 'description': '', 'components': [{'name': 'navigation', 'description': '', 'components': [], 'commandDefinitions': [], 'eventDefinitions': [], 'variableDefinitions': [{'enumDefinition': None, 'floatDefinition': None, 'matrixDefinition': {'rows': 1, 'columns': 3, 'defaultValue': None}, 'octetDefinition': None, 'sintDefinition': None, 'stringDefinition': None, 'timeDefinition': None, 'name': 'position_vector', 'description': 'Cartesian position vector [x, y, z], that describes the current position of the satellite in the GCRF coordinate frame.', 'unit': 'm'}, {'enumDefinition': None, 'floatDefinition': None, 'matrixDefinition': {'rows': 1, 'columns': 3, 'defaultValue': None}, 'octetDefinition': None, 'sintDefinition': None, 'stringDefinition': None, 'timeDefinition': None, 'name': 'velocity_vector', 'description': 'Cartesian velocity vector [vx, vy, vz], that describes the current velocity of the satellite in the GCRF coordinate frame.', 'unit': 'm/s'}], 'tmSetDefinitions': []}], 'commandDefinitions': [], 'eventDefinitions': [], 'variableDefinitions': [], 'tmSetDefinitions': [], 'norad_id': None, 'opm_object_id': None, 'custom_fields': None})
